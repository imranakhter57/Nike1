...
while ($row=  mysqli_fetch_array($res)){
    ...
    if ($_SESSION['admin'] == 1) {echo "<td>";?> <input type="button" class="side"id="delete1<?php echo $row["s_id"];?>" name="<?php echo $row["s_id"];?>" value="delete"  onclick="delete1(<?php echo $row["s_id"];?>)"><br> 
